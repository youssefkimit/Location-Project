<?php 
	...
	catch(Exception $e)
	{
	 ...
	 $statementDelete=$db->prepare('DELETE FROM projet_location WHERE email=:email');
     $statementDelete->execute(array('email'=>$_COOKIE['email']));
 ?>
 <!DOCTYPE html>
<html>
<head>
           ...
           <div class="rows">
               ...
               <div class="col-md-8 mt-1 right-side">
                   <div class="card mb-3 content">
                       <h1 class="m-3 pt-3" style="color: red; font-weight: bold;">Votre compte page est supprimé!</h1>
                           </div>
