<?php
  ...
  $statementUpdate=$db->prepare('UPDATE signup SET AgencyName=:nom,password=:password,ConfirmPassword=:Cpassword,AgencyAddress=:address WHERE AgencyEmail=:email');
  $statementUpdate->execute(array('nom'=>$_POST['name'],'password'=>$_POST['password'],'Cpassword'=>$_POST['password'],'address'=>$_POST['address'],'email'=>$_COOKIE['email']));
  ?>
  <!DOCTYPE html>
<html>
<head>
