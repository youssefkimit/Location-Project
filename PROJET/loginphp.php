...
<?php
	...
	<?php foreach($signups as $signup):?>
		<?php if($_POST['name']==$signup['AgencyEmail']&&$_POST['Password']==$signup['password']):?>
               <?php $d=1; ?> 
...
<?php endforeach;?>
<?php if($d==0):?>
	<h1>Ce compte n'existe pas</h1><button type="submit"><a href="login.html" style="text-decoration: none; color: white;">Retour</a></button>
<?php endif;?>
