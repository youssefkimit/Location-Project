<?php
	...
	$su=$db->prepare("INSERT INTO signup( AgencyName,AgencyEmail,password, ConfirmPassword,AgencyAddress,CommercialRegister) VALUES (:name,:email,:password,:confirm,:address,:register)");
	$su->execute(array(':name' => $_POST['nom'],':email' => $_POST['email'],':password' => $_POST['Password'],':confirm' => $_POST['Confirm'],':address' => $_POST['address'],':register' => $_POST['register']));
  }
}
  catch(Exception $e)
  {
           ...
           <div class="rows">
               ...
               <div class="col-md-8 mt-1 right-side">
                   <div class="card mb-3 content">
                       <h1 class="m-3 pt-3" style="color: green; font-weight: bold;">Merci,votre agence ont été enregistrées avec succès!</h1>
