<?php
    ...
    $su->execute();
    $signups=$su->fetchAll();
    foreach($signups as $projet_location){
        if ($projet_location['email']==$_COOKIE['email']) {
            break;
        }
    }
    ?>
               ...
               <div class="col-md-4 mt-1 left-side">
                   <div class="card text-center sidebar">
                       <div class="card-body">
                           ...
                           <div class="mt-3">
                               <h3><?php echo $projet_location['nom'];?></h3>
                       ...
                       <div class="card-body">
                           <div class="row">
                               ...
                               <div class="col-md-9 text-secondary">
                                   <input type="text" name="name" value="<?php echo $projet_location['nom'];?>">
                               </div>
                           </div><hr>
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-9 text-secondary">
                                   <input type="text" name="password" value="<?php echo $projet_location['mot_pass'];?>">
                               </div>
                           </div><hr>
                           <div class="row">
                               <div class="column1">
                               ...
                               <div class="col-md-9 text-secondary">
                                   <input type="text" name="cin" value="<?php echo $projet_location['cin'];?>">
                               </div>
                           </div>
