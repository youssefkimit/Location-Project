<?php 
        $temps=365*24*3600;
        setcookie("email",$_POST['name'],time()+$temps);?>
...
<?php
  ...
  $sqlQuery='SELECT * FROM projet_location';
  $su=$db->prepare($sqlQuery);
  $su->execute();
  $signups=$su->fetchAll();?>
  <?php
  $d=0;?>
  <?php foreach($signups as $location_projet):?>
    <?php if($_POST['name']==$location_projet['email']&&$_POST['Password']==$location_projet['mot_pass']):?>
               <?php $d=1; ?> 
           ...
           <div class="rows">
               <div class="col-md-4 mt-1 left-side">
                   <div class="card text-center sidebar">
                       <div class="card-body">
                           ...
                           <div class="mt-3">
                               <h3><?php echo $location_projet['nom'];?></h3>
               ...
               <div class="col-md-8 mt-1 right-side">
                   <div class="card mb-3 content">
                       <h1 class="m-3 pt-3" style=" font-weight: bold;">Profil</h1>
                       ...
                       <div class="card-body">
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-9 text-secondary">
                                   <?php echo $location_projet['email'];?>
                               </div>
                           </div><hr>
                           <div class="row">
                               <div class="column1">
                               ...
                               <div class="col-md-9 text-secondary">
                                   <?php echo $location_projet['mot_pass'];?>
                               </div>
                           </div><hr>
                           <div class="row">
                               <div class="column1">
...
<div style="display: flex; margin-top:300px">
            <div>
            <form>
           <button style="background-color: #f44336; width: 80px; height: 30px; border-radius: 5px;"><a href="c.html" style="text-decoration: none; color:white; font-size: 20px;">Retour</a></button>
           </form>
          </div>
           <div>
           <form action="update.php">
           <button style="background-color: #f44336; width: 80px; height: 30px; border-radius: 5px; margin-left: 10px; margin-right: 10px;"><a style="text-decoration: none; color:white; font-size: 20px;">Modifier</a></button>
           </form>
           </div>
           <div>
           <form action="delete.php">
           <button style="background-color: #f44336; width: 200px; height: 30px; border-radius: 5px;"><a style="text-decoration: none; color:white; font-size: 20px;">Supprimer le compte</a></button>
           </form>
           </div>
        </div>
...
<?php endforeach;?>
<?php if($d==0):?>
  <h1>Ce compte n'existe pas</h1><button type="submit"><a href="c.html" style="text-decoration: none; color: white;">Retour</a></button>
<?php endif;?>
